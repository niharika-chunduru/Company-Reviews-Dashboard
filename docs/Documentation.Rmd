...
## Scenario-3: Adding more data scources companies
While not impossible, this scenario will demand the most amount or work, as the data from the new source will need to be preprocessed and normalized a format that is consistent with the existing data. 
